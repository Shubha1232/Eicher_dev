...
<td colspan='4' style='border-left:0px;'>Format No:- AP04:460:10F</td></tr>";
...
echo "<tr><td colspan='12' style='background-color:#ccc;text-align: left; border-left:0px;'>1) Material Grade: ".$result['grade']."</td></tr>";	
...
echo "
	...
	</tr><tr style='text-align: center;'><td colspan='2'>".$data['metallurgical_test_core_hardness_ID_location']."</td>
	    <td colspan='2'>".$data['metallurgical_test_core_hardness_ID_requirement']."</td>
		<td colspan='2'>".$data['metallurgical_test_core_hardness_ID_observation']."</td>
	</tr>
	";
...
echo "<tr style='text-align: center;'><td colspan='2'>Location</td><td colspan='2'>Specification(mm)</td><td colspan='2'>Observations(mm)</td></tr>
	...
	<tr style='text-align: center;'><td colspan='2'>".$data['thread_hardness_location']."</td>
	<td colspan='2'>".$data['thread_hardness_requirement']."</td>
	<td colspan='2'>".$data['thread_hardness_observation']."</td>
								 </tr>
								";
