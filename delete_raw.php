...
$crud = new Database();
$user_id = $_POST["id"];
$qss = 'SELECT report_no FROM metallurgical_report WHERE id='.$user_id;
...
$qs = 'SELECT `email` FROM email';
        ...
        $mail = new PHPMailer(true);                              // Passing `true` enables exceptions
             ...
             $mail->SMTPOptions = array(
                ...
                $mail->Subject = 'Raw Material Entery Deleted';
                $mail->Body    = 'Raw Material deleted with report_no '.$rss['report_no'].'  by '.$_SESSION['user_name'];
