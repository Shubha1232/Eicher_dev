...
$img1 =$fol."/image/zf.jpg";
$content.='<tr><th colspan="15"><img src="'.$img1.'" width="100px" height="30px"></th><th colspan="6">Format No:- AP04:460:10Z</th></tr>';
...
$content.='<tr><td colspan="3">1) Raw Material :</td><td colspan="4">'.$result['grade'].'</td><td colspan="3">Heat No:</td><td colspan="4">'.$result['heat_no'].'</td><td colspan="3">Steel Code:</td><td colspan="4">'.$data['steel_code'].'</td></tr>';
...
$content.='<tr><td colspan="21">2.2 Effective Case Depth @ '.$data['cut_off_point'].'</td></tr>';
