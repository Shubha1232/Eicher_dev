...
<!-- breadcrumbs -->
            <div class="container-fluid">
                <ul id="breadcrumbs">
                    ...
                    <li><a href="javascript:void(0)">Unit list</a></li>
                </ul>
            </div>
<!-- main content -->
             <?php 
                        ...
                        <div class="w-box">
                             <div class="w-box-header">
                               ...
                               <div class="pull-right">
                                    <a href="add_unit"><span class="label"><i class="splashy-add_small"></i><span class="jQ-todoAll-count">New Unit</span></span></a>
                                </div>
                            </div>
                       ...
                       foreach ($result as $key => $value) {
                          ...
                          ?>
                                        <tr>
                                            ...
                                            <td><a href="edit_unit.php?id=<?php echo $value['id']; ?>"><i class="icsw16-pencil"></i></i></a>
											<?php if ($_SESSION['user_type'] == '1'){
													?>
											<a onClick="userConfirmation(<?php echo $value['id']; ?>,'delete_unit.php')" href="#"><i class="icsw16-trashcan"></i></i></a>
											<?php } ?>
											</td>
