...
else if($result['customer'] == 'TAFE'){
$img1 =$fol."/image/TAFE.jpg";
$unique = 'AP04:460:10T';
}
...
if($result['customer'] == 'POLARIS'){ 
$content.='<tr><td colspan="3">Material Spec:-</td><td colspan="4">'.$data['material_spec'].'</td><td colspan="3">Module(mm):-</td><td colspan="4">'.$data['module'].'</td><td colspan="3">Chordial Thickness:-</td><td colspan="4">'.$data['chordial_thick'].'</td></tr>';
}
...
$content.='<tr><td>PCD</td>';
  ...
  $content.='<tr><td colspan="7">'.$data['metallurgical_test_nmtp_surface_pcd_location'].'</td><td colspan="7">'.$data['metallurgical_test_nmtp_surface_pcd_requirement'].'</td><td colspan="7">'.$data['metallurgical_test_nmtp_surface_pcd_observation'].'</td></tr>';
$content.='<tr><td colspan="7">'.$data['metallurgical_test_nmtp_surface_rcd_location'].'</td><td colspan="7">'.$data['metallurgical_test_nmtp_surface_rcd_requirement'].'</td><td colspan="7">'.$data['metallurgical_test_nmtp_surface_rcd_observation'].'</td></tr>'; 
}
