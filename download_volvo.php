...
echo "<tr><td colspan='2' style='border-left:0px;'><img src='".$fol."/image/vo.png'></td>
<td colspan='6' style='text-align:center;font-size:16px; border-left:0px;'></td>
<td colspan='4' style='border-left:0px;'>Format No :- AP04:460:10V</td></tr>";
}else{
echo "<tr><td colspan='2' style='border-left:0px;border-top:0px;'><img src='".$fol."/image/vst.png'></td>
<td colspan='7' style='text-align:center;font-size:14px; border-top: 0px; border-left:0px;'></td>
<td colspan='3' style='border-left:0px;border-top:0px;'>Format No :- AP04:460:10VS</td></tr>";
}	
...
echo "<tr><td colspan='12' style='background-color:#ccc;text-align: left; border-left:0px;'>";
	echo "1) Material Grade: ".$result['grade']."</td></tr>";
...
echo "<tr style='text-align: center;'><td colspan='2' >Elements (%) <span style='font-size:20px;'>&#8594;</span> </td>
<td>C</td>
<td>Mn</td><td>S</td>
                                    <td>P</td>
								<td>Si</td>
...
if($result['customer'] == 'JOHN DEERE'){ echo "SAE 12620H"; } echo"</td><td>Min</td>";
    for ($i=0; $i<12; $i++) {
            echo  "<td style='width:20px !important;'>".$chemical_composition_min[$i]."</td>";
           			}
"</tr>";
...
echo "
	<tr><td colspan='6' rowspan='10' style='width:500px;   border-left: 0px; border-top: 0px;'><div><img src='".$fol."/image/".$result['image_graph']."' /></div></td>
...
echo "<tr><td colspan='12' style='border-left: 0px;'><table class='table display nowrap table-bordered'>
    ...
    <td style='border-top: 0px;'>1.0</td><td style='border-top: 0px;'>1.1</td><td style='border-top: 0px;'>1.2</td><td style='border-top: 0px;'>1.3</td><td style='border-top: 0px;'>1.4</td><td style='border-top: 0px;'>1.5</td><td style='border-top: 0px;'>1.6</td><td style='border-top: 0px;'>1.7</td><td style='border-top: 0px;'>1.8</td><td style='border-top: 0px;'>1.9</td><td style='border-top: 0px;'>2.0</td>
	</tr>
    <tr>";
...
echo "<tr>
	...
	<tr>
	<td colspan='4' style='text-align: center;border-left: 0px;'>".$data['micro_photo_location3']."</td>
	<td colspan='4' style='text-align: center;'>".$data['micro_photo_specification3']."</td>
	<td colspan='4' style='text-align: center;'>".$data['micro_photo_observation3']."</td>
	 </tr>
	<tr>
