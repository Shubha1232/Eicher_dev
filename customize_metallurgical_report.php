                    ...
                    <div class="span12">
                        ...
                        <div class="w-box">
                            ...
                            <div class="w-box-content cnt_a">
                                ...
                                <button class="btn btn-beoro-1" id="customer_report" onclick="pdffun();" style="float: right; margin-right: 9px;">PDF</button>
								<button class="btn btn-info" onclick="printfun();" style="float: right; margin-right: 5px;">Word</button>
                                <form class="form-horizontal" action="" id="control_plan_form" method="post" enctype="multipart/form-data">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" id="date" name="date" class="datepicker" value="<?php echo $response['date']; ?>" required="" readOnly=""/></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                               <td rowspan="3" class="bg-color">THIRD PARTY</td>
                                                ...
                                                <td><input type="text" id="weight" name="weight" value="<?php echo $response['weight']; ?>" required=""/></td>
                                                            ...
                                                            <div id="div1" class="div-scroll">
                                                                <table class="table">
                                                                    ...
                                                                    <tr>
                                                                       ...
                                                                       <?php
                                                                         for($i=0; $i<18; $i++) {
                                                                    echo  '<td style="padding-left:0px;padding-right:0px;"><input class="innerBoxes" type="text" id="chemical_composition_min'.$i.'" name="chemical_composition_min[]" value="'.$chemical_composition_min[$i].'"/></td>';
                                                                         }
                                                                       ?>
                                                                   </td>
                                                                    ...
                                                                    <tr>
                                                                       ...
                                                                       <?php
                                                                         for($i=0; $i<18; $i++) {
                                                                    echo  '<td style="padding-left:0px;padding-right:0px;"><input class="innerBoxes" type="text" id="chemical_composition_max'.$i.'" name="chemical_composition_max[]" value="'.$chemical_composition_max[$i].'"/></td>';
                                                                         }
                                                                       ?>
                                                                   </td>
                                                                    ...
                                                                    <tr>
                                                                       ...
                                                                       <?php
                                                                         for($i=0; $i<18; $i++) {
																	   ?>
                                                                    <td style="padding-left:0px;padding-right:0px;"><input class="innerBoxes" type="text" id="chemical_composition_milltc<?php echo $i; ?>" name="chemical_composition_milltc[]" onkeyup="calculateAverage(<?php echo $i; ?>,this)" value="<?php echo $chemical_composition_milltc[$i]?>"/></td>
																		<script>
                                                                    ...
                                                                    <tr>
                                                                       ...
                                                                       <?php
                                                                         for($i=0; $i<18; $i++) {
																			 ?>
                                                                     <td style="padding-left:0px;padding-right:0px;"><input class="innerBoxes" type="text" id="chemical_composition_forgertc<?php echo $i; ?>" name="chemical_composition_forgertc[]" onkeyup="calculateAverage(<?php echo $i; ?>,this)" value="<?php echo $chemical_composition_forgertc[$i]?>"/></td>
																	<script>
																		 $(document).ready(function(){
                                                                    ...
                                                                    <tr>
                                                                       ...
                                                                       <?php
                                                                         for($i=0; $i<18; $i++) { ?>
                                                                    <td style="padding-left:0px;padding-right:0px;"><input class="innerBoxes" type="text" id="chemical_composition_partyremark<?php echo $i; ?>" name="chemical_composition_partyremark[]" onkeyup="calculateAverage(<?php echo $i; ?>,this)" value="<?php echo $chemical_composition_partyremark[$i]?>"/></td>
                                                                      <script>
																		 $(document).ready(function(){
                                                                   ...
                                                                   <tr>
                                                                       ...
                                                                       <?php
                                                                        for($i=0; $i<18; $i++) {
                                                                    echo  '<td style="padding-left:0px;padding-right:0px;"><input class="innerBoxes" type="text" id="chemical_composition'.$i.'" name="chemical_composition[]" onkeyup="calculateAverage('.$i.')" value="'.$chemical_composition[$i].'"/></td>';
                                                                         }
                                                                       ?>
                                                                   </td>
                                                                   </tr>
                                                                   <tr>
                                                                       ...
                                                                       <?php
                                                                         for($i=0; $i<18; $i++) {
                                                                    echo  '<td style="padding-left:0px;padding-right:0px;"><input class="innerBoxes" type="text" id="chemical_composition2'.$i.'" name="chemical_composition2[]" onkeyup="calculateAverage('.$i.')" value="'.$chemical_composition2[$i].'"/></td>';
                                                                         }
                                                                       ?>
                                                                   </td>
                                                                   </tr>
                                            ...
                                            <tr>
                                              <td><input onkeyup="part_check(<?php echo $i; ?>)" type="text" id="part_no<?php echo $i; ?>" value="<?php echo $part_no[$i] ?>" name="part_no[]" onkeyup="getForgingImage('forging_image<?php echo $i ?>','part_no<?php echo $i ?>')"><p id="forging_image<?php echo $i ?>" style="margin:5px 0px 0px;">
											  ...
											  <td><?php echo $rso['steel_code']; ?></td>-->
												...
												<td colspan="1"><input type="text" id="date" style="width: 75%;" name="part_date[]" value="<?php echo $part_date[$i]; ?>" readOnly=""/></td>
											...
											<tr>
                                              <td><input onkeyup="part_check(<?php echo $p; ?>)" type="text" id="part_no<?php echo $p; ?>" name="part_no[]" onkeyup="getForgingImage('forging_image<?php echo $p ?>','part_no<?php echo $p; ?>')"><p id="forging_image<?php echo $p ?>" style="margin:5px 0px 0px;"></p></td>
                                              ...
                                              <td colspan="1"><textarea id="remark" name="remark[]" class="span12"></textarea></td>
...
function calculatebloom(){
            ...
            $(function(){
			 ...
			 function pdffun(){		
                $("#control_plan_form").attr("action","metallurgical_pdf.php");
                $("#control_plan_form").submit();
		   }
		   
		    function printfun(){
                $("#control_plan_form").attr("action","metallurgical_print.php");
                $("#control_plan_form").submit();    
	   }
...
<script>
    ...
    $(add_button).click(function(e){ //on add input button click
        ...
        if(x < max_fields){ //max input box allowed
            ...
            $(wrapper).append('<tr><td><input onkeyup="part_check'+x+'" type="text" id="part_no'+x+'" name="part_no[]" ></td><td><input type="text" id="observed" name="observed[]"></td><td id="verified_by_td'+x+'"><select id="part_grade'+x+'" name="part_grade[]" style="width:140px;"><option value="">Select</option><?php $query = 'SELECT * FROM grade';$result = $crud->getAllData($query);foreach ($result as $key => $value) {?><option value="<?php echo $value['id']; ?>" ><?php echo $value['grade']; ?></option><?php } ?></select></td><td><select style="width:140px !important" id="accept" name="accept[]"><option value="">Select</option><option value="ACCEPTED">ACCEPTED</option><option value="REJECTED">REJECTED</option><option value="ACCEPT UNDER DEVIATION">ACCEPT UNDER DEVIATION</option></select></td><td colspan="2"><textarea id="remark" name="remark[]" class="span12"></textarea></td></tr>'); //add input box
        }
    });
