                    ...
                    <div class="span12">
                        ...
                        <div class="w-box">
                            ...
                            <div class="w-box-content cnt_a">
                                ...
                                <form class="form-horizontal" action="add_part_sub.php" id="partno_form" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="span2">
                                            ...
                                            <div class="">
                                                ...
                                                <input type="text" onkeyup="checkPart()" onblur="" id="part_no_1"  name="part_no" style="width: 140px;">
