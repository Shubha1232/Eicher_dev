...
<td colspan='7' style='text-align:left;font-size:16px; border-left:0px;'></td>";

 if($result['customer'] == 'AUTOLAC'){

echo "<td colspan='3' style='border-left:0px;'>Format No:- AP04:460:10A</td>";

} 

 if($result['customer'] == 'DANA SPICER'){

echo "<td colspan='3' style='border-left:0px;'>Format No:- AP04:460:10D</td>";

} 

if($result['customer'] == 'ESCORTS'){

echo "<td colspan='3' style='border-left:0px;'>Format No:- AP04:460:10ES</td>";

}

 if($result['customer'] == 'SPICER INDIA'){

echo "<td colspan='3' style='border-left:0px;'>Format No:- AP04:460:10SI</td>";

} 

 if($result['customer'] == 'TMA'){

echo "<td colspan='3' style='border-left:0px;'>Format No:- AP04:460:10TMA</td>";

} 
if($result['customer'] == 'TUFF TURQ'){

echo "<td colspan='3' style='border-left:0px;'>Format No:- AP04:460:10TT</td>";
...
echo "<tr><td colspan='2' style='border-left: 0px;'>Qty:-</td>

<td colspan='2' style='border-left: 0px;'>".$result['qty']."</td><td colspan='2'>Customer:-</td>

<td colspan='2' style='border-left: 0px;'>".$result['customer']."</td><td colspan='2'>Batch Code:-</td>

<td colspan='2' style='border-left: 0px;'>".$result['batch_code']."</td></tr>";
...
echo "
	...
	<tr><td colspan='6' rowspan='11' style='width:500px;   border-left: 0px; border-top: 0px;'><div><img src='".$fol."/image/".$result['image_graph']."' /></div></td>
	...
	</tr><tr style='text-align: center;'><td colspan='2'>".$data['metallurgical_test_core_hardness_rcd_location']."</td>
...
echo "<tr style='text-align: center;'><td colspan='2'>Location</td><td colspan='2'>Specification(mm)</td><td colspan='2'>Observations(mm)</td></tr>
	...
	<tr style='text-align: center;'><td colspan='2'>".$data['metallurgical_test_case_location1']."</td>

	<td colspan='2'>".$data['metallurgical_test_case_requirement1']."</td>

	<td colspan='2'>".$data['metallurgical_test_case_observation1']."</td>

								 </tr>

	<tr style='text-align: center;'><td colspan='2'>".$data['metallurgical_test_case_location2']."</td>

	<td colspan='2'>".$data['metallurgical_test_case_requirement2']."</td>

	<td colspan='2'>".$data['metallurgical_test_case_observation2']."</td>
