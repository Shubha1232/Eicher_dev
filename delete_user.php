...
$crud = new Database();
$user_id = $_POST["id"];
$qss = 'SELECT full_name FROM users WHERE id='.$user_id;
...
$qs = 'SELECT `email` FROM email';
        ...
        $mail = new PHPMailer(true);                              // Passing `true` enables exceptions
             ...
             $mail->SMTPOptions = array(
                ...
                $mail->Subject = 'User Entery Deleted';
                $mail->Body    = 'User deleted with User_name '.$rss['full_name'].'  by '.$_SESSION['user_name'];
