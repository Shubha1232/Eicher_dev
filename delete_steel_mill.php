...
$crud = new Database();
$user_id = $_POST["id"];
$qss = 'SELECT name FROM steel_mill WHERE id='.$user_id;
...
$qs = 'SELECT `email` FROM email';
        ...
        $mail = new PHPMailer(true);                              // Passing `true` enables exceptions
             ...
             $mail->SMTPOptions = array(
                ...
                $mail->Subject = 'Steel mill Entery Deleted';
                $mail->Body    = 'Steel mill deleted with name '.$rss['name'].'  by '.$_SESSION['user_name'];
