...
$crud = new Database();
$part_id = $_POST["id"];
$qss = 'SELECT part_no FROM part_number WHERE id='.$part_id;
...
$qs = 'SELECT `email` FROM email';
        ...
        $mail = new PHPMailer(true);                              // Passing `true` enables exceptions
             ...
             $mail->SMTPOptions = array(
                ...
                $mail->Subject = 'Part Entery Deleted';
                $mail->Body    = 'Part deleted with Part_no '.$rss['part_no'].'  by '.$_SESSION['user_name'];
