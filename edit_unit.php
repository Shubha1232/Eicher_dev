                    ...
                    <div class="span12">
                        <div class="w-box">
                            <div class="w-box-header">
                                <p style="text-align: center;">Edit Unit</p>
                            </div>
                            <div class="w-box-content cnt_a">
                                ...
                                <form class="form-horizontal" action="edit_unit_sub.php" id="user_form" method="post">
                                    
                                        
                                        <div class="control-group">
                                            <label class="control-label bg-color1" for="unit_name">Unit Name</label>
                                            <div class="controls">
											  <input type="hidden" id="id" name="id" value="<?php echo $result["id"]; ?>">
                                                <input type="text" id="unit_name" name="unit_name" value="<?php echo $result["name"]; ?>">
                                            </div>
                                        </div>
