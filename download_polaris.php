...
if($result['customer'] == 'POLARIS'){
echo "<tr><td colspan='2' style='border-left:0px;'></td>
<td colspan='6' style='text-align:center;font-size:16px; border-left:0px;'></td>
<td colspan='4' style='border-left:0px;'>Format No:- AP04:460:10P</td></tr>";
}
if($result['customer'] == 'TAFE'){
echo "<tr><td colspan='2' style='border-left:0px;'><img src='".$fol."/image/TAFE.jpg'></td>
<td colspan='6' style='font-size:14px; border-left:0px;'></td>
<td colspan='4' style='border-left:0px;'>Format No:- AP04:460:10T</td></tr>";
}
...
if($result['customer'] == 'POLARIS'){	
echo "<tr><td colspan='2' style='border-left: 0px;'>Material Spec:-</td><td colspan='2' style='border-left: 0px;'>".$data['material_spec']."</td><td colspan='2'>Module(mm):-</td><td colspan='2' style='border-left: 0px;'>".$data['module']."</td><td colspan='2'>Chordial Thickness:-</td><td colspan='2' style='border-left: 0px;'>".$data['chordial_thick']."</td></tr>";
}
	echo "<tr><td colspan='12' style='background-color:#ccc;text-align: left; border-left:0px;'>";
	echo "1) Raw Material:".$result['grade']."</td></tr>";	
if($result['customer'] == 'TAFE'){	
...
echo "<tr style='text-align: center;'><td colspan='2' style=''>Elements (%) -> </td><td>C</td><td>Mn</td><td>S</td>
                                    <td>P</td>
								<td>Si</td>
									<td>Ni</td>
									<td>Cr</td>
...
echo "<tr style='text-align: center;'><td rowspan='2' style=''>";
echo"</td><td>Min</td>";
    for ($i=0; $i<12; $i++) {
...
echo "<tr><td colspan='6' rowspan='10' style='width:500px;   border-left: 0px; border-top: 0px;'><div><img src='".$fol."/image/".$result['image_graph']."' /></div></td>
	...
	<tr style='text-align: center;'><td colspan='2'>".$data['metallurgical_test_core_hardness_pcd_location']."</td>
...
echo "<tr><td colspan='12' style='border-left: 0px;'><table class='table display nowrap table-bordered'><tr>
	...
	";
echo "
	<tr><td colspan='4' style='text-align: center;border-left: 0px;' >".$data['metallurgical_test_micro_core_location']."</td>
	...
	if($result['customer'] == 'POLARIS'){
echo 	 "<tr><td colspan='4' style='text-align: center;border-left: 0px;' >".$data['micro_photo_location5']."</td>
	...
	<tr><td colspan='4' style='text-align: center;border-left: 0px;' >".$data['metallurgical_test_nmtp_surface_pcd_location']."</td>
	<td colspan='4' style='text-align: center;'>".$data['metallurgical_test_nmtp_surface_pcd_requirement']."</td>
	<td colspan='4' style='text-align: center;'>".$data['metallurgical_test_nmtp_surface_pcd_observation']."</td>
	</tr>
	<tr><td colspan='4' style='text-align: center;border-left: 0px;' >".$data['metallurgical_test_nmtp_surface_rcd_location']."</td>
	<td colspan='4' style='text-align: center;'>".$data['metallurgical_test_nmtp_surface_rcd_requirement']."</td>
	<td colspan='4' style='text-align: center;'>".$data['metallurgical_test_nmtp_surface_rcd_observation']."</td>
	</tr>";
	}
	
echo	"<tr> <td colspan='4' style='text-align: center;border-left: 0px;' >".$data['micro_photo_location4']."</td>
