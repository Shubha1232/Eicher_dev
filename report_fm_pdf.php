...
$content.='<tr><th colspan="15"></th><th colspan="6">Format No:- AP04:460:10F</th></tr>';
...
$content.='<tr><td colspan="3">'.$data['metallurgical_test_core_hardness_ID_location'].'</td><td colspan="3">'.$data['metallurgical_test_core_hardness_ID_requirement'].'</td><td colspan="3">'.$data['metallurgical_test_core_hardness_ID_observation'].'</td></tr>';
