...
$crud = new Database();
$user_id = $_POST["id"];
$qss = 'SELECT customer_id FROM customer_standard WHERE id='.$user_id;
...
$qs = 'SELECT `email` FROM email';
        ...
        $mail = new PHPMailer(true);                              // Passing `true` enables exceptions
             ...
             $mail->SMTPOptions = array(
                ...
                $mail->Body    = 'Customer deleted with customer_id '.$rss['customer_id'].'  by '.$_SESSION['user_name'];
