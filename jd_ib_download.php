...
echo "<tr><td colspan='4' style='border-left:0px;border-top:0px;'></td>
<td colspan='6' style='text-align:left;font-size:8px; border-top: 0px; border-left:0px;'></td>
<td colspan='2' style='border-left:0px;border-top:0px;'>Format No:- AP04:460:10JI</td></tr>";
echo "<tr><td colspan='12' style='border-left:0px;text-align:center;'>MATERIALS LABORATORY REPORT</td></tr>";
...
echo "<tr><td colspan='2' style='border-left: 0px;'>Carb/Diff Time:</td><td colspan='2' style='border-left: 0px;'>".$data['curbeizing_time']."/".$data['diffusion_time']." &#032; min</td>
<td colspan='2'>Furnace ID</td><td colspan='2' style='border-left: 0px;'>".$data['furnace_no']."</td>
<td colspan='2'>Qch Media/Grade:</td><td colspan='2' style='border-left: 0px;'>".$data['qch_grade']."</td></tr>";
...
echo "<tr><td colspan='6'>2.2 Effective Case Depth at 50 HRC(515 Hv)</td></tr>";
...
echo "<tr><td colspan='12' style='border-left: 0px;'>2.4 Microstructure: Inspect as per JDV21</td></tr>";
	...
	<td colspan='3' style='text-align: center;'>".$data['micro_photo_observation3']."</td>
     ...
     <tr>
	 <td rowspan='3' colspan='3' style='height:300px;border-left: 0px; text-align: center;'>200x</td>
	...
	*- In case RA is more than 25%, check Hardness(with 100 gm load) at 0.1 mm it should be 58 HRC Min.
	...
	<td colspan='12' style='border-left: 0px;'>Remarks : ".$result['remark']."</td>
					...
					<tr><td style='border-left: 0px;'>Checked by :-</td><td colspan='3'>".$rs['full_name']."</td><td>Verified by : -</td><td colspan='3'>".$rs3['full_name']."</td><td>Approved by :-</td><td colspan='3'>".$rs2['full_name']."</td></tr>
";
