...
<!-- breadcrumbs -->
            <div class="container-fluid">
                <ul id="breadcrumbs">
                    ...
                    <li><a href="javascript:void(0)">Add User Type</a></li>
                </ul>
            </div>
<!-- main content -->
            <div class="container-fluid"">
                    ...
                    <div class="span12">
                        <div class="w-box">
                            <div class="w-box-header">
                                <p style="text-align: center;">Add User Type</p>
                            </div>
                            <div class="w-box-content cnt_a">
                                ...
                                <form class="form-horizontal" action="add_user_type_sub.php" method="post" id="add_user_form">
                                    
                                        
                                        <div class="control-group">
                                            <label class="control-label bg-color1" for="user_type">User Type</label>
                                            <div class="controls">
